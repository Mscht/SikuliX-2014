...
//TODO: implement prefMoreHighlight
		...
		prefUseImageRepo.setSelected(prefs.getPrefUseImageRepo());
		if (! prefs.getPrefImageRepoPath().isEmpty()) {
			prefImageRepoPath.setText(prefs.getPrefImageRepoPath());
		}
...
//TODO: command bar as menu
  ...
  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        prefLblImageRepo = new javax.swing.JLabel();
        prefUseImageRepo = new javax.swing.JCheckBox();
        prefImageRepoPath = new javax.swing.JTextField();
        ...
        prefLblImageRepo.setText("Global image repository");

        prefUseImageRepo.setText("activate global image repository *");
        prefUseImageRepo.setToolTipText("... restart needed"); // NOI18N
        prefUseImageRepo.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent evt) {
                prefUseImageRepoStateChanged(evt);
            }
        });

        prefImageRepoPath.setText("PathToImageRepository (absolute or relative to bundle path)");
        prefImageRepoPath.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                prefImageRepoPathActionPerformed(evt);
            }
        });
        prefImageRepoPath.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                prefImageRepoPathKeyTyped(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .add(layout.createSequentialGroup()
                .add(32, 32, 32)
                .add(prefLblImageRepo)
                .add(30, 30, 30)
                .add(prefUseImageRepo))
            .add(layout.createSequentialGroup()
                .add(32, 32, 32)
                .add(prefImageRepoPath, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 538, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
            .add(layout.createSequentialGroup()
                .add(6, 6, 6)
        ...
        layout.setVerticalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(prefUseImageRepo))
                .add(6, 6, 6)
                .add(prefImageRepoPath, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .add(6, 6, 6)
	...
	private void savePrefs(String msg)	{
		...
		prefs.setPrefUseImageRepo(isSelected(prefUseImageRepo));
		...
		if (! prefImageRepoPath.getText().startsWith("PathToImageRepository")) {
			prefs.setPrefImageRepoPath(prefImageRepoPath.getText());
		}
		setStatus(msg, true);
	}
  ...
  private void prefUseImageRepoStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_prefUseImageRepoStateChanged
		isSelected(prefUseImageRepo);
  }//GEN-LAST:event_prefUseImageRepoStateChanged
  ...
  private void prefImageRepoPathKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_prefImageRepoPathKeyTyped
    // TODO add your handling code here:
  }//GEN-LAST:event_prefImageRepoPathKeyTyped
  ...
  private void prefImageRepoPathActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_prefImageRepoPathActionPerformed
    // TODO add your handling code here:
  }//GEN-LAST:event_prefImageRepoPathActionPerformed
  ...
  private void prefMorePlainStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_prefMorePlainStateChanged
    ...
    private javax.swing.JTextField prefImageRepoPath;
    private javax.swing.JLabel prefLblImageRepo;
    ...
    private javax.swing.JCheckBox prefUseImageRepo;
